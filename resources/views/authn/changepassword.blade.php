                                        ...
                                        <div class="col-sm-8 col-sm-offset-2">
                                            <div class="form-container">
                                                <form action="{{route('change_password')}}" method="post">
                                                    <div class="form-group password {{ $errors->has('current_password') ? ' error has-error ' : '' }}">
                                                        <label class="sr-only" for="c_password">Your Current Password</label>
                                                        <input id="c_password" name="current_password" value="{{Request::old('current_password') ?: ''}}" type="password" class="form-control" placeholder="Current Password">
                                                    ...
                                                    <div class="form-group password {{ $errors->has('new_password') ? ' error has-error ' : '' }}">
                                                        <label class="sr-only" for="new_password">New Password</label>
                                                        <input id="new_password" name="new_password" value="{{Request::old('new_password') ?: ''}}" type="password" class="form-control" placeholder="New Password">
                                                    ...
                                                    <div class="form-group password {{ $errors->has('new_password_confirmation') ? ' error has-error ' : '' }}">
