...
<div class="general">
    <div class="row">
        <form id="fullform" action="<?php echo e(route('phonebook.add_multiple')); ?>" method="post" role="form">
            <div class="form-group" id="form-group-error">
                ...
                <div class="row" id="group-btn">
                    ...
                    <?php foreach($groups as $group): ?>
                        <input style="float: left;text-align: center;margin: 5px" type="button" id="<?php echo e($group->name); ?>" class="btn btn-success col-sm-2" value="<?php echo e($group->name); ?>" >
                    <?php endforeach; ?>
                </div>
            </div>
    ...
    <div class="col-md-12 form-group">
        ...
        <div class="">
            ...
            <select onchange="loadform('<?php echo e(url('phonebook/genForm')); ?>?no='+this.value)" name="" id="">
