...
<?php $__env->startSection('head'); ?>
    ...
    <?php /*<link rel="stylesheet" type="text/css" href="/accordion/css/default.css" />*/ ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('accordion/css/component.css')); ?>" />
    <script src="<?php echo e(asset('accordion/js/modernizr.custom.js')); ?>"></script>
        ...
        <div class="container">
            ...
            <div class="row general">
                <div class="col-md-9 col-sm-8 col-md-push-3"> <!--=======  col-md-8 START =========-->
                    ...
                    <form id="composeform" action="<?php echo e(route('sendSMS')); ?>" method="post" role="form">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 ">

<?php echo $__env->make('partials.flashAlert', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            	<div id="form-subject-error" class="form-group <?php echo e($errors->has('subject') ? ' error has-error ' : ''); ?> ">
                            		<label for="">Subject Or Sender Id</label>
                            		<input type="text" placeholder="Subject Of SMS Message" class="form-control" value="<?php echo e(isset($message->subject) ? $message->subject: Request::old('subject')); ?>" name="subject" id="">
                                ...
                                <div id="form-recipients-error" class="form-group <?php echo e($errors->has('recipients') ? ' error has-error ' : ''); ?> ">
                                    <label for="">Recipients</label>
                                    <textarea class="form-control" placeholder="Seperate Multiple Phone Numbers By Comma(,) E.g 08022222222,08033333333,07022222222" name="recipients"><?php echo e(isset($message->recipients) ? $message->recipients: Request::old('recipients')); ?></textarea>
                                    <span id="recipients-error" class="help-block"></span>
                                    <?php if($errors->has('recipients')): ?>
                                        <span class="help-block">
                                                        <?php echo e($errors->first('recipients')); ?>

                                                    </span>
                                    <?php endif; ?>
                                </div>
                                <div id="form-body-error" class="form-group <?php echo e($errors->has('body') ? ' error has-error ' : ''); ?> ">
                                    <label for="">Message Body</label>
                                    <textarea id="content" class="form-control" placeholder="Content Of Your SMS Message" name="body"><?php echo e(isset($message->content) ? $message->content : Request::old('body')); ?></textarea>
                                    <p id="data"></p>
                                ...
                                <div class="widget-content">
                                    <ul class="blog_archieve">
                                        ...
                                        <?php foreach($groups as $group): ?>
                                            <li <?php echo ($no >3)? "class='showNON' style='display: none;'":""?> ><input type="checkbox" data-toggle="tooltip" data-placement="top" title="Click To Add <?php echo e($group->contacts->count()); ?> Contacts From The <?php echo e($group->name); ?> Contact Group" name="group[]" number="<?php echo e($group->contacts->count()); ?>" class="option-input checkbox" id="group-<?php echo e($group->id); ?>" value="<?php echo e($group->id); ?>"> <?php echo e($group->name); ?> (<?php echo e($group->contacts->count()); ?>)</li>
                                        <?php $no++;?>
                                            <?php endforeach; ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('accordion/js/jquery.cbpNTAccordion.min.js')); ?>"></script>
    <script>
        /*
         *
         * Accordion Plugin
    ...
    <script>
        ...
        $('#recipientSave').click(function(){
            swal({
                ...
                inputOptions: {
                    <?php foreach($groups as $group): ?>
                        '<?php echo e($group->id); ?>' : '<?php echo e($group->name); ?>',
                    <?php endforeach; ?>
                },
