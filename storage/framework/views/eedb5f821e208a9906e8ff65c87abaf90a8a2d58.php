...
<?php $__env->startSection('head'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('tabs/css/tabs.css')); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('tabs/css/tabstyles.css')); ?>" />
    <script src="<?php echo e(asset('tabs/js/modernizr.custom.js')); ?>"></script>
                            ...
                            <div id="tabstylez" class="tabs tabs-style-linebox">
                                ...
                                <div class="content-wrap">
                                    ...
                                    <section id="section-linebox-2">
                                        <?php echo $__env->make('phonebook.upload', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </section>
                                    <section id="section-linebox-3">
                                        <?php echo $__env->make('phonebook.groups', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </section>
                                    <section id="section-linebox-4">
                                        <?php echo $__env->make('phonebook.multiple', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </section>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('tabs/js/cbpFWTabs.js')); ?>"></script>
