        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-8 col-md-push-3"> <!--=======  col-md-8 START =========-->
                    ...
                    <h2 class="shortcodes-title">EMAIL TEMPLATES <div class="pull-right">
                            <a href="<?php echo e(route('newTemplate')); ?>" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-plus-sign"></i> New Template</a>
                        </div></h2>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $(document).ready(function () {
            ajaxLoad('<?php echo e(route('listTemplates')); ?>');
        });
    </script>
<?php $__env->stopSection(); ?>
